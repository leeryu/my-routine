...
const context = {
  ...
  caches: { async open(){return cache;}, async keys(){return ['routine-v8','routine-v9','routine-v10'];}, async delete(k){deleted.push(k);return true;}, async match(req){const key=typeof req==='string'?req:req.url; return store.get(key);}},
